package com.xiongyi.cg.controller.system.createcode;
...
import com.xiongyi.cg.service.createcode.CreateCodeManager;
import com.xiongyi.cg.util.AppUtil;
import com.xiongyi.cg.util.DateUtil;
import com.xiongyi.cg.util.DelAllFile;
import com.xiongyi.cg.util.FileDownload;
import com.xiongyi.cg.util.FileZip;
import com.xiongyi.cg.util.Freemarker;
import com.xiongyi.cg.util.Jurisdiction;
import com.xiongyi.cg.util.PageData;
import com.xiongyi.cg.util.PathUtil;


/**
 * @author GUXIONG
 * @description CreateCodeController 代码生成器
 *
 */
@Controller
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		String ftlPath = "generatorCode";								//ftl路径
