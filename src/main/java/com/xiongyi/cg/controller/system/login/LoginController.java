package com.xiongyi.cg.controller.system.login;
...
import com.xiongyi.cg.entity.Menu;
import com.xiongyi.cg.entity.Role;
import com.xiongyi.cg.entity.User;
import com.xiongyi.cg.service.appuser.AppuserManager;
...
import com.xiongyi.cg.util.RightsHelper;
	...
	public Map<String, String> getUQX(String USERNAME){
		...
		try {
			...
			if("admin".equals(USERNAME)){
				buttonQXnamelist = xybuttonService.listAll(pd);					//admin用户拥有所有按钮权限
			}else{
